import { memo, useCallback, useEffect, useMemo, useRef, useState, type CSSProperties, type Key, type ReactNode, type RefObject } from 'react';
import './LogoLoop.css';
      ...
      (item: LogoItem, key: Key) => {
        ...
        const itemContent = item.href ? (
          <a
            ...
            href={item.href}
            aria-label={itemAriaLabel || 'tautan logo'}
            target="_blank"
